...
export const appStyles = StyleSheet.create({
  ...
  glow: { position: 'absolute', pointerEvents: 'none', borderRadius: 999, backgroundColor: '#8B5CF6', opacity: 0.12 },
  ...
  formCard: { backgroundColor: 'rgba(255, 255, 255, 0.05)', borderColor: 'rgba(255, 255, 255, 0.10)', borderRadius: 16, borderWidth: 1, boxShadow: '0px 8px 20px rgba(0, 0, 0, 0.28)', elevation: 6, padding: 20 },
  ...
  button: { alignItems: 'center', backgroundColor: '#7C3AED', borderColor: 'rgba(196, 181, 253, 0.45)', borderRadius: 12, borderWidth: 1, boxShadow: '0px 6px 12px rgba(139, 92, 246, 0.30)', elevation: 4, marginTop: 20, paddingVertical: 15 },
  ...
  resultCard: { alignItems: 'center', backgroundColor: 'rgba(255, 255, 255, 0.04)', borderColor: 'rgba(139, 92, 246, 0.28)', borderRadius: 16, borderWidth: 1, boxShadow: '0px 8px 18px rgba(139, 92, 246, 0.16)', elevation: 5, marginTop: 18, padding: 20 },
